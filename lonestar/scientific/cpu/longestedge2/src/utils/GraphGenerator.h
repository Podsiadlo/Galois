...
public:
  ...
  //    // terrain data into the map; the height (z coordinate) is retrieved
  //    from
  //    // said map
  //
  //    // SW
  //    const Coordinates& coordinates0 =
  //        Coordinates{Utils::convertToUtm(south_border, west_border, map),
  //        map};
  //    // NW
  //    const Coordinates& coordinates1 =
  //        Coordinates{Utils::convertToUtm(north_border, west_border, map),
  //        map};
  //    // SE
  //    const Coordinates& coordinates2 =
  //        Coordinates{Utils::convertToUtm(south_border, east_border, map),
  //        map};
  //    // NE
  //    const Coordinates& coordinates3 =
  //        Coordinates{Utils::convertToUtm(north_border, east_border, map),
  //        map};
  //
  ...
  //    nodes.push_back(connManager.createNode(NodeData{false, coords[0],
  //    false})); nodes.push_back(connManager.createNode(NodeData{false,
  //    coords[1], false}));
  //    nodes.push_back(connManager.createNode(NodeData{false, coords[2],
  //    false})); nodes.push_back(connManager.createNode(NodeData{false,
  //    coords[3], false})); galois::gInfo("Nodes created.");
  //
  ...
  //                                   south_border, false)},
  //        bottomBorderLength);
  //    // this edge is diagonal from SW to NE with middle point being the
  //    center
  ...
  //        NodeData{false, Coordinates{south_border, west_border, map},
  //        false}));
  //    nodes.push_back(connManager.createNode(
  //        NodeData{false, Coordinates{north_border, west_border, map},
  //        false}));
  //    nodes.push_back(connManager.createNode(
  //        NodeData{false, Coordinates{south_border, east_border, map},
  //        false}));
  //    nodes.push_back(connManager.createNode(
  //        NodeData{false, Coordinates{north_border, east_border, map},
  //        false}));
  //
  //    //        nodes.push_back(connManager.createNode(NodeData{false,
  //    //        Coordinates{west_border, south_border}, false}));
  ...
  //            map.get_height(west_border, (north_border + south_border)
  //            / 2.)},
  //        length1);
  //    connManager.createEdge(
  //        nodes[1], nodes[3], true,
  ...
  //            map.get_height(east_border, (north_border + south_border)
  //            / 2.)},
  //        length3);
  //    connManager.createEdge(
  //        nodes[0], nodes[2], true,
  ...
  prepareSimplestGraph(const double west_border, const double north_border,
    ...
    edges.emplace_back(Edge{coords[2], coords[3], true, version2D});
    edges.emplace_back(Edge{coords[3], coords[1], true, version2D});
    edges.emplace_back(Edge{coords[1], coords[0], true, version2D});
    edges.emplace_back(Edge{coords[0], coords[3], false, version2D});
